...
class WorkerManager(object):
  ...
  def __init__(self, func_caller, worker_ids, poll_time):
    """ Constructor. """
...
# Instantiation of WorkerManager: A worker manager for synthetic time experiments
# -------------------------------------------------------------------------------
class SyntheticWorkerManager(WorkerManager):
  """ A Worker manager for synthetic functions. """

  def __init__(self, func_caller, num_workers, poll_time=0.001):
    """ Constructor. """
    self.worker_pipe = None
    super(SyntheticWorkerManager, self).__init__(func_caller, num_workers, poll_time)
...
# Instantiation of WorkerManager: A worker manager for real time experiments
# --------------------------------------------------------------------------
