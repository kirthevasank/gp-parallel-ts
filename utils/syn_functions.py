...
import numpy as np
# Local imports
from function_caller import get_function_caller_from_function
...
def get_hartmann_high_d_function_caller(domain_dim, **kwargs):
  ...
  return get_function_caller_from_function(_eval_highd_hartmann_func, domain_bounds,
...
def get_hartmann_function_caller(domain_dim, **kwargs):
  ...
  return get_function_caller_from_function(hartmann_func, domain_bounds, vectorised=False,
...
def get_shekel_function_caller(**kwargs):
  ...
  return get_function_caller_from_function(shekel_func, domain_bounds, vectorised=False,
                                           opt_pt=opt_pt, opt_val=opt_val, **kwargs)
...
def get_currin_exp_function_caller(**kwargs):
  ...
  return get_function_caller_from_function(currin_exp_func, domain_bounds=domain_bounds,
...
def get_branin_function_caller(**kwargs):
  ...
  return get_function_caller_from_function(branin_func, domain_bounds=domain_bounds,
    vectorised=False, opt_val=opt_val, opt_pt=opt_pt, **kwargs)
...
def get_branin_high_d_function_caller(domain_dim, **kwargs):
  ...
  return get_function_caller_from_function(_eval_highd_branin_func, domain_bounds,
           vectorised=False, opt_pt=opt_pt, opt_val=opt_val, **kwargs)
...
def get_borehole_function_caller(**kwargs):
  ...
  domain_bounds = [[0.05, 0.15],
                   ...
                   [1120, 1680],
                   [9855, 12045]]
  return get_function_caller_from_function(borehole_func, domain_bounds=domain_bounds,
    vectorised=False, opt_val=opt_val, opt_pt=opt_pt, **kwargs)
...
def get_park1_function_caller(**kwargs):
  ...
  domain_bounds = [[0, 1]] * 4
  return get_function_caller_from_function(func, domain_bounds=domain_bounds,
           vectorised=False, opt_val=opt_val, opt_pt=opt_pt, **kwargs)
...
def get_high_d_function_caller_from_low_d_func(domain_dim, low_d_func,
  ...
  # Return
  func_caller = get_function_caller_from_function(high_d_func,
                                                  domain_bounds=high_d_domain_bounds,
                                                  vectorised=False,
...
def get_high_d_function_caller_from_low_d_func_caller(domain_dim,
  ...
  return get_high_d_function_caller_from_low_d_func(domain_dim, low_d_func_caller.func,
           low_d_func_caller.domain_bounds, low_d_func_caller.opt_val,
           low_d_func_caller.opt_pt_unnormalised, **kwargs)
...
#   elif function_name.lower().startswith('hartmann'):
#     return get_hartmann_high_d_function_caller_from_descr(function_name, **kwargs)
#   elif function_name.lower().startswith('branin'):
#     return get_hartmann_high_d_function_caller_from_descr(function_name, **kwargs)
  else:
    return get_high_d_function_caller_from_description(descr=function_name, **kwargs)
#     raise NotImplementedError('Not implemented synthetic function %s yet'%(
#                               function_name))
